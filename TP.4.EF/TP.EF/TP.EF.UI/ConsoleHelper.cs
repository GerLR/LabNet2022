...
namespace TP.EF.UI
{
    public static class ConsoleHelper
    {
        ...
        {
            Console.Clear();
            Console.WriteLine("Bienvenido a Northwind");
        ...
        public static void ListarSuppliers()
        {
            ...
            // Se toman 3 propiedades de la entidad suppliers para simplificar
        ...
        {
            // Se completan sólo 3 parámetros para simplificar
